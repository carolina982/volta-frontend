...
const styles = StyleSheet.create({
  ...
  listRow: { gap: 12 }, emptyState: {paddingVertical: 48,paddingHorizontal: 20,alignItems: "center",gap: 8, },
  ...
  card: {backgroundColor: "#fafafa", borderRadius: 14, borderWidth: 1, borderColor: "#e5e7eb", padding: 14, flex: 1,},
  cardMobile: { width: "100%" },
  cardDesktop: { minWidth: 0, maxWidth: "49%" as any },
  imageWrap: {position: "relative",alignSelf: "flex-start",marginBottom: 12,  ...(Platform.OS === "web" ? { cursor: "pointer" as const } : {}),},
  unitImage: {width: 88,height: 88,borderRadius: 14,backgroundColor: "#e5e7eb",},
  unitImagePlaceholder: {width: 88,height: 88,borderRadius: 14,backgroundColor: "#f3f4f6",borderWidth: 1,borderColor: "#e5e7eb",alignItems: "center",justifyContent: "center",},
  photoBadge:{position: "absolute", right: -4, bottom: -4, width: 24, height: 24,borderRadius: 12,backgroundColor: "#111111",alignItems: "center",justifyContent: "center",borderWidth: 2,borderColor: "#ffffff",},
  ...
  iconAction:{width: 36,height: 36,borderRadius: 18,backgroundColor: "#ffffff",borderWidth: 1,borderColor: "#e5e7eb",alignItems: "center",justifyContent: "center",
